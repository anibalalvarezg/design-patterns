...
const obs1 = new Observer<number>((n) => console.log(`Hello ${n}`))
const obs2 = new Observer<number>((n) => console.log(`Hi ${n}`))
...
const obs1String = new Observer<string>((s) => console.log(s.toUpperCase()));
const obs2String = new Observer<string>((s) => console.log(s.toLowerCase()));
